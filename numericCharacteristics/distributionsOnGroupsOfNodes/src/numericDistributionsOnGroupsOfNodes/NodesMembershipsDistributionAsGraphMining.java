...
public class NodesMembershipsDistributionAsGraphMining extends GraphWithSingleGroupsOfNodesSetMiner {
	...
	public MinerResults mine(IGraph graph, ISetOfGroupsOfNodes groupsOfNodes,
		...
		NumericCharacteristic distribution = Computer.computeNodesInCommunitiesMembershipsDistribution(graph, groupsOfNodes);
